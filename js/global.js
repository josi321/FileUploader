...
// this will add the class drop to upload-console-drop when someone hovers files over the dropbox (adding visuals)
	dropZone.ondragover = function() {
		this.className = 'upload-console-drop drop';
		return false;
	};

// this removes the drop class when the user is not hovering drop zone. back to normal
